    ...
    <div className="bg-black bg-cover bg-center h-screen">
     ...
     <section className="justify-items-center pt-16 ">
      ...
      <form action="#" class="space-y-8">
          ...
          <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-electric-blue sm:w-fit hover:bg-electric-blue focus:ring-4 focus:outline-none focus:ring-electric-blue dark:bg-dark-blue dark:hover:bg-primary-700 dark:focus:ring-primary-800 dark:hover:text-black">Send message</button>
      </form>
  </div>
</section>
